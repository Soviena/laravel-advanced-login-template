      ...
      <div class="col-md-12">
        <div class="card mb-4">
          ...
          <form action="{{route('editUser',Auth::user()->id)}}" method="put" enctype="multipart/form-data" id="formSubmit">
            @csrf
            <div class="card-body py-1" style="background-image: url({{asset('img/backgrounds/1370945.png')}}); background-size:cover">
              <div class="d-flex justify-content-start mb-4" style="margin-top: 15%;">
                <div class="d-block" style="position: relative; display: inline-block;">
                  ...
                  <!-- X Button -->
                  <button type="button" id="resetPicButton" onclick="resetImage()" disabled hidden style="position: absolute; top: 0; right: 2%; background-color: white; border: 0; border-radius: 50%; width: 30px; height:30px; cursor: not-allowed;">
